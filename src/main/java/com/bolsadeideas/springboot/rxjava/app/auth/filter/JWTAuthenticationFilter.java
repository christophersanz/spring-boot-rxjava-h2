package com.bolsadeideas.springboot.rxjava.app.auth.filter;
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		if(username != null && password !=null) {
			...
			try {
				 ...
				 logger.info("Username desde request InputStream (x-www-form-urlencoded | raw): " + username);
				 logger.info("Password desde request InputStream (x-www-form-urlencoded | raw): " + password);
